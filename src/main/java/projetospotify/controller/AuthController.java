...
public class AuthController {
    ...
    public String callback(@RequestParam("code") String code, @RequestParam("state") String state, Model model) {
        ...
        if (response.getStatusCode() == HttpStatus.OK) {
            ...
            try {
                String responseBodyJson = new ObjectMapper().writerWithDefaultPrettyPrinter().writeValueAsString(responseBody);
            ...
            if (userInfoResponse.getStatusCode() == HttpStatus.OK) {
                ...
                try {
                    String userInfoJson = new ObjectMapper().writerWithDefaultPrettyPrinter().writeValueAsString(userInfo);
